    ...
    <form class="login-form" action="{{ url('/auth/login') }}" method="post">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <img src="/images/advir-white.png" style="width:100%">
                <p>We join together to grow together, just like a flower flourishes in nature within a healthy
                    ecosystem.</p>
            </div>
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon{{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off"
                               placeholder="Password" name="password" value="{{ old('password') }}"/></div>
                    ...
                    <ul class="social-icons">
                        <li>
                            <a class="facebook" data-original-title="facebook"
                               href="{{url('/socialauth/facebook')}}"> </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="googleplus" data-original-title="Goole Plus"
                               href="{{url('/socialauth/google')}}"> </a>
                        </li>
                        <li>
                            <a class="linkedin" data-original-title="Linkedin"
                               href="{{url('/socialauth/linkedin')}}"> </a>
                        </li>
                    </ul>
                </div>
