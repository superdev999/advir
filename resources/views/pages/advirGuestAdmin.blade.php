...
<head>
    ...
    <script>
        $( document ).on( "pagecreate", function() {
            ...
            window.uploadPath = "/static/uploads"+"/{{#username}}{{username}}{{/username}}"+"/";
...
<div class="header">
    ...
    <h1></h1><br><b class="welcomeTxt">Welcome,  <span class="userName">{{#username}}{{username}}{{/username}}</span></b>
...
<div class="controls">
    <div class="ui-content" role="main">
        ...
        <form id="uploadForm" class="uploadForm ui-mini" enctype="multipart/form-data" action="/upload" method="post">
            <input class="" type="file" name="userUpload" multiple="multiple">
...
<div class="details">
    ...
    <div id="detailsContainer" class="detailsContainer">
        <div class="objectsContainer">
            {{#items}}
            <div class="object" data-name="{{objectName}}"><div class="objectName"><span class="nameTxt">{{objectName}}</span></div><img data-for="{{objectName}}" class="objectImg" src="{{url}}" alt="{{url}}"></div>
            {{/items}}
        </div>
...
<div class="available">
    ...
    <div class="inner">
        ...
        {{#files}}
        <div class="object"><img class="objectImg" src="../../..{{#uploadPath}}{{{uploadPath}}}{{/uploadPath}}{{.}}" data-fileName="{{.}}" ></div>
        {{/files}}
    </div>
</div>
