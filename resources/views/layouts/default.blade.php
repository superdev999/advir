					...
					<ul class="nav metismenu" id="side-menu">
						...
						<li class="{{ Request::is('events*') ? 'active' : '' }}">
							...
							<ul class="nav nav-second-level collapse">
								<li class="{{ Request::is('events*') && !Request::is('events/pending*') ? 'active' : '' }}"><a href="#">Accepted Events</a></li>
								<li class="{{ Request::is('events/pending*') ? 'active' : '' }}"><a href="#">Pending Events</a></li>
							</ul>
						</li>
						<li class="{{ Request::is('review*') ? 'active' : '' }}">
							<a href="#"><i class="fa fa-search"></i> <span class="nav-label">Review</span></a>
						</li>
					</ul>
